...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="/simpan-makanan" method="post" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="row text-center">
                        <div class="col-6">
                            <a href="/hapus-makanan/{{ $item->id }}" class="btn btn-sm btn-danger">Hapus</a>
                        </div>
                        <div class="col-6">
                            <a href="/edit-makanan/{{ $item->id }}" class="btn btn-sm btn-warning">Edit</a>
                        </div>
                    </div>
                </div>
            </div>
